	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				//  2: a hyphen, underscore, or period that transitions to state 2 
				...
				// '-', '_', or '.' -> State 2
				else if (currentChar == '-' || currentChar == '_'|| currentChar == '.') {	// Check for '-', '_', and '.'
					nextState = 2;
			...
			case 2: 
				// State 2 deals with a character after a hyphen, underscore, or period in the name.
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a hyphen, underscore, or period must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
